...
<style>
    ...
    .status-bar {
        background: linear-gradient(135deg,rgb(140, 167, 204) 0%, #20c997 100%);
        color: white;
        padding: 1rem 2rem;
        border-radius: 15px;
        margin-bottom: 2rem;
        ...
        <div class="col-lg-8 mb-4">
            ...
            <div class="row g-4">
                ...
                <?php elseif ($user_type === 'community'): ?>
                    <!-- Community Cards -->
                    <div class="col-md-4">
                        <a href="service-directory.php" class="text-decoration-none">
                    ...
                    <!-- Add similar styling for other community cards -->
